...
Ext.Panel = Ext.extend(Ext.Container, {
     ...
     * the panel will attempt to load its contents immediately upon render.
     */
    /**
     * @cfg {Boolean} frame
...
tools:[{
     ...
     * maximize, restore, gear, pin, unpin, right, left, up, down, refresh, minus, plus, help, search and save.  Note that
