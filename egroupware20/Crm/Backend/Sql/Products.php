...
/**
 * this classes provides access to the sql table egw_metacrm_product
 * 
 * @package     Crm
 ...
 *
 */
class Crm_Backend_Sql_Products extends Zend_Db_Table_Abstract
{
    protected $_name = 'egw_metacrm_product';
