...
/**
 * this classes provides access to the sql table egw_metacrm_leadtype
 * 
 * @package     Crm
 ...
 *
 */
class Crm_Backend_Sql_Leadtypes extends Zend_Db_Table_Abstract
{
    protected $_name = 'egw_metacrm_leadtype';
