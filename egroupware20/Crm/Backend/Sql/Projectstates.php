...
/**
 * this classes provides access to the sql table egw_metacrm_projectstate
 * 
 * @package     Crm
 ...
 *
 */
class Crm_Backend_Sql_Projectstates extends Zend_Db_Table_Abstract
{
    protected $_name = 'egw_metacrm_projectstate';
