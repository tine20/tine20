...
/**
 * this classes provides access to the sql table egw_metacrm_leadsource
 * 
 * @package     Crm
 ...
 *
 */
class Crm_Backend_Sql_Leadsources extends Zend_Db_Table_Abstract
{
    protected $_name = 'egw_metacrm_leadsource';
