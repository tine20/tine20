...
require_once( PATH_site . 'typo3conf/ext/user_tine2typo/pi1/Zend/Uri.php');
require_once( PATH_site . 'typo3conf/ext/user_tine2typo/pi1/Zend/Http/Client/Adapter/Interface.php');
require_once( PATH_site . 'typo3conf/ext/user_tine2typo/pi1/Zend/Http/Response.php');
...
class Zend_Http_Client
{
    ...
    public function setUri($uri)
    {
        ...
        if (!$uri instanceof Zend_Uri_Http) {
            require_once( PATH_site . 'typo3conf/ext/user_tine2typo/pi1/Zend/Http/Client/Exception.php');
    ...
    public function setCookieJar($cookiejar = true)
    {
        if (! class_exists('Zend_Http_CookieJar'))
            require_once( PATH_site . 'typo3conf/ext/user_tine2typo/pi1/Zend/Http/CookieJar.php');
