...
require_once( PATH_site . 'typo3conf/ext/user_tine2typo/pi1/Zend/Uri/Http.php');
...
class Zend_Http_Client_Adapter_Socket implements Zend_Http_Client_Adapter_Interface
{
    ...
    {
        if (! is_array($config)) {
            require_once( PATH_site . 'typo3conf/ext/user_tine2typo/pi1/Zend/Http/Client/Adapter/Exception.php');
