...
//            'accountEmailAddress'   => 'phpunit@metaways.de' // use TestServer::getPrimaryMailDomain()
//        ));
//
...
//            'accountEmailAddress'   => 'phpunit@tine20.org' /7 use TestServer::getPrimaryMailDomain()
//        ));
//
