...
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Erp_ControllerTest::main');
}

/**
 * Test class for Tinebase_Group
 */
class Erp_ControllerTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
		$suite  = new PHPUnit_Framework_TestSuite('Tine 2.0 Erp Controller Tests');
    ...
    {
        $this->_backend = Erp_Controller_Contract::getInstance();
