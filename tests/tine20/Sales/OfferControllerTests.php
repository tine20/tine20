...
class Sales_OfferControllerTests extends TestCase
{
    ...
    public function testNumberable()
    {
        ...
        $this->assertEquals('ANG-00001', $record->number);
        
        $record = $controller->create(new Sales_Model_Offer(array('title' => 'auto2')));
        
        $this->assertEquals('ANG-00002', $record->number);
        ...
        $this->assertEquals('ANG-00004', $record->number);
        ...
        $this->assertEquals('ANG-00005', $record->number);
        
        // the user manually set this numer, so this should be corrected
        $record = $controller->create(new Sales_Model_Offer(array('title' => 'manu1', 'number' => 'ANG-100')));
        $this->assertEquals('ANG-00100', $record->number);
    }
}
