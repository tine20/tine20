 ...
 */
class Calendar_Convert_Event_VCalendar_EMClientTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $suite  = new \PHPUnit\Framework\TestSuite('Tine 2.0 Calendar WebDAV EM Client Event Tests');
