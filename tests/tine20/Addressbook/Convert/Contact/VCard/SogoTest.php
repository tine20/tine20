 ...
 */
class Addressbook_Convert_Contact_VCard_SogoTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $suite  = new \PHPUnit\Framework\TestSuite('Tine 2.0 Addressbook WebDAV Sogo Contact Tests');
