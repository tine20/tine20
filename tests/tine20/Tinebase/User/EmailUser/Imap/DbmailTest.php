 ...
 */
class Tinebase_User_EmailUser_Imap_DbmailTest extends \PHPUnit\Framework\TestCase
{
    /**
     * email user backend
     *
    ...
    {
        $suite  = new \PHPUnit\Framework\TestSuite('Tinebase_User_EmailUser_Imap_DbmailTest');
