...
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Tine20_Tinebase_Record_AbstractTest::main');
}
...
if (PHPUnit_MAIN_METHOD == 'Tine20_Tinebase_Record_AbstractTest::main') {
    Tine20_Tinebase_Record_AbstractTest::main();
}
