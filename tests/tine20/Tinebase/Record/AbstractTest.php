 ...
 */
abstract class Tinebase_Record_AbstractTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var    test objects
     * @access protected
    ...
    protected function tearDown(): void
{
    ...
    {
        $this->expectException('Tinebase_Exception_Record_DefinitionFailure');
