...
if (!defined('PHPUnit_MAIN_METHOD')) {
    define('PHPUnit_MAIN_METHOD', 'Tine20_Tinebase_Record_ContainerTest::main');
}
 ...
 */
class Tine20_Tinebase_Record_ContainerTest extends Tine20_Tinebase_Record_AbstractTest
{
    /**
