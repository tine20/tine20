...
Zeile 3</AirSyncBase:Data></AirSyncBase:Body><Calendar:Timezone>xP///wAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAoAAAAFAAMAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMAAAAFAAIAAAAAAAAAxP///w==</Calendar:Timezone><Calendar:UID>3452c1dd3f21d1c12589e517f0c6a928137113a4</Calendar:UID><Calendar:DtStamp>20101104T070652Z</Calendar:DtStamp><Calendar:Subject>GM straussberg2</Calendar:Subject><Calendar:MeetingStatus>1</Calendar:MeetingStatus><Calendar:OrganizerName>Nadine Blau</Calendar:OrganizerName><Calendar:OrganizerEmail>meine@mail.com</Calendar:OrganizerEmail><Calendar:Attendees><Calendar:Attendee><Calendar:Name>Nadine Blau</Calendar:Name><Calendar:Email>meine@mail.com</Calendar:Email></Calendar:Attendee></Calendar:Attendees><Calendar:BusyStatus>0</Calendar:BusyStatus><Calendar:AllDayEvent>1</Calendar:AllDayEvent><Calendar:StartTime>20101103T230000Z</Calendar:StartTime><Calendar:EndTime>20101106T230000Z</Calendar:EndTime><Calendar:Sensitivity>0</Calendar:Sensitivity></ApplicationData></Change></Commands></Collection></Collections></Sync>';
    ...
    protected $_testXMLInput_SamsungGalaxyStatus = '<?xml version="1.0" encoding="utf-8"?><!DOCTYPE AirSync PUBLIC "-//AIRSYNC//DTD AirSync//EN" "http://www.microsoft.com/"><Sync xmlns="uri:AirSync" xmlns:AirSyncBase="uri:AirSyncBase" xmlns:Calendar="uri:Calendar"><Collections><Collection><Class>Calendar</Class><SyncKey>20</SyncKey><CollectionId>calendar-root</CollectionId><DeletesAsMoves/><GetChanges/><WindowSize>5</WindowSize><Options><FilterType>4</FilterType><BodyPreference xmlns="uri:AirSyncBase"><Type>1</Type><TruncationSize>400000</TruncationSize></BodyPreference></Options><Commands><Change><ServerId>b2b0593bc21c89e5d07edb7b5caa56ff7e243e92</ServerId><ApplicationData><Timezone xmlns="uri:Calendar">xP///wAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAoAAAAEAAMAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAMAAAAFAAIAAAAAAAAAxP///w==</Timezone><AllDayEvent xmlns="uri:Calendar">0</AllDayEvent><StartTime xmlns="uri:Calendar">20120229T120000Z</StartTime><EndTime xmlns="uri:Calendar">20120229T140000Z</EndTime><DtStamp xmlns="uri:Calendar">20120228T093153Z</DtStamp><Subject xmlns="uri:Calendar">testtermin</Subject><Sensitivity xmlns="uri:Calendar">0</Sensitivity><OrganizerEmail xmlns="uri:Calendar">user2@example.com</OrganizerEmail><Reminder xmlns="uri:Calendar">30</Reminder><UID xmlns="uri:Calendar">2b4a047d3f71b4d47d2d3907f4a27d70f650cd30</UID><Attendees xmlns="uri:Calendar"><Attendee><Name>user1@example.com</Name><Email>user1@example.com</Email><AttendeeType>1</AttendeeType></Attendee><Attendee><Name>user2@example.com</Name><Email>user2@example.com</Email><AttendeeType>1</AttendeeType></Attendee><Attendee><Name>user3@example.com</Name><Email>user3@example.com</Email><AttendeeType>1</AttendeeType></Attendee></Attendees><BusyStatus xmlns="uri:Calendar">0</BusyStatus><MeetingStatus xmlns="uri:Calendar">3</MeetingStatus></ApplicationData></Change></Commands></Collection></Collections></Sync>';
