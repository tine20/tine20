 ...
 *
 */
class TimeZoneConvert_KnownNamesMap {
    ...
    /**
     * @see http://msdn.microsoft.com/en-us/library/aa563018(loband).aspx
     * 
     * NOTE: this list is not conclusive there are multiple timezones haveing the same id
     *       it might be better to take the add the names to the map
     */
