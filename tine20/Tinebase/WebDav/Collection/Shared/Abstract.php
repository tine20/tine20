 ...
 * @subpackage  WebDAV
 */
abstract class Tinebase_WebDav_Collection_Shared_Abstract extends Sabre_DAV_Collection implements Sabre_DAV_IProperties, Sabre_DAVACL_IACL
{
    /**
    ...
    */
    public function getChild($_name)
    {
        ...
        switch(count($pathParts)) {
            ...
            case 1:
                try {
                    $container = $_name instanceof Tinebase_Model_Container ? $_name : Tinebase_Container::getInstance()->getContainerByName($this->_application->name, $_name, Tinebase_Model_Container::TYPE_SHARED);
