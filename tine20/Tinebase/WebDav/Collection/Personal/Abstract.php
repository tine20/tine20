 ...
 * @subpackage  WebDAV
 */
abstract class Tinebase_WebDav_Collection_Personal_Abstract extends Sabre_DAV_Collection implements Sabre_DAV_IProperties, Sabre_DAVACL_IACL
{
    /**
     ...
     */
    public function __construct(Tinebase_Model_FullUser $_user, $_path = null)
    {
        $this->_user = $_user;
        $this->_path = (!empty($_path)) ? $_path : $this->_user->accountLoginName;
    ...
    */
    public function getChild($_name)
    {
        ...
        switch(count($pathParts)) {
            ...
            case 1:
                try {
                    $container = $_name instanceof Tinebase_Model_Container ? $_name : Tinebase_Container::getInstance()->getContainerByName($this->_application->name, $_name, Tinebase_Model_Container::TYPE_PERSONAL);
    ...
    function getChildren()
    {
        ...
        switch(count($pathParts)) {
            ...
            # list container
            case 1:
                $containers = Tinebase_Container::getInstance()->getPersonalContainer(Tinebase_Core::getUser(), $this->_application->name, $this->_user, Tinebase_Model_Grants::GRANT_READ);
