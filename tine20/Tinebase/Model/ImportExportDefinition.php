 ...
 * @property string plugin_options_definition
 * @property array  plugin_options_definition_json
...
class Tinebase_Model_ImportExportDefinition extends Tinebase_Record_NewAbstract
{
    ...
    const FLDS_PLUGIN_OPTIONS_DEFINITION_JSON = 'plugin_options_definition_json';
    ...
    protected static $_modelConfiguration = [
        ...
        self::FIELDS        => [
            ...
            self::FLDS_PLUGIN_OPTIONS_DEFINITION_JSON => [
                self::VALIDATORS => [Zend_Filter_Input::ALLOW_EMPTY => true],
                self::TYPE => self::TYPE_VIRTUAL,
                self::SHY => true,
            ],
