...
class Tinebase_Controller_BankHoliday extends Tinebase_Controller_Record_Abstract
{
    ...
    protected function __construct()
    {
        ...
        $this->_modelName = Tinebase_Model_BankHoliday::class;
        $this->_backend = new Tinebase_Backend_Sql([
            Tinebase_Backend_Sql::TABLE_NAME        => Tinebase_Model_BankHoliday::TABLE_NAME,
            Tinebase_Backend_Sql::MODEL_NAME        => Tinebase_Model_BankHoliday::class,
