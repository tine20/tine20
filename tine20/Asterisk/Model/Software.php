 ...
 * @package     Asterisk Management
 */
class Asterisk_Model_Software extends Tinebase_Record_Abstract
{
    /**
    ...
    protected $_validators = array(
        ...
        'phonemodel'		    	=> array(Zend_Filter_Input::ALLOW_EMPTY => true),
        'softwareimage'		        => array(Zend_Filter_Input::ALLOW_EMPTY => true)
    );

    /**
     * converts a int, string or Asterisk_Model_Software to an software id
     *
     * @param int|string|Asterisk_Model_Software $_softwareId the software id to convert
     * @return int
     */
    static public function convertSoftwareIdToInt($_softwareId)
    {
        if ($_softwareId instanceof Asterisk_Model_Software) {
