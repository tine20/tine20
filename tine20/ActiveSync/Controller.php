...
class ActiveSync_Controller extends Tinebase_Controller_Event
{
    ...
    public static function initSyncrotonRegistry()
    {
        ...
        $syncState = new Syncroton_Backend_SyncState(Tinebase_Core::getDb(), SQL_TABLE_PREFIX . 'acsync_');
        $syncState->_logger = Tinebase_Core::getLogger();
        ...
        Syncroton_Registry::set(Syncroton_Registry::SYNCSTATEBACKEND,    $syncState);
