 ...
 * @subpackage  Acl
 */
class MailFiler_Acl_Rights extends Tinebase_Acl_Rights_Abstract
{
    /**
     * @static string
     */
    ...
    public static function getInstance() 
    {
        if (self::$_instance === NULL) {
            self::$_instance = new MailFiler_Acl_Rights;
        }
    ...
    {
        $translate = Tinebase_Translation::getTranslation('MailFiler');
