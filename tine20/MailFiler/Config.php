...
/**
 * MailFiler config class
 * 
 * @package     MailFiler
 * @subpackage  Config
 */
class MailFiler_Config extends Tinebase_Config_Abstract
{
    ...
    protected static $_properties = array(
        self::PUBLIC_DOWNLOAD_URL => array(
            ...
            'label'                 => 'Public Download URL',
                                   //_('Possible status. Please note that additional status might impact other MailFiler systems on export or syncronisation.')
