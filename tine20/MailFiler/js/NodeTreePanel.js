 ...
 * @class Tine.MailFiler.NodeTreePanel
 * @extends Tine.widgets.container.TreePanel
 * 
 * @author Martin Jatho <m.jatho@metaways.de>
 */

Tine.MailFiler.NodeTreePanel = function(config) {
    ...
    Tine.MailFiler.NodeTreePanel.superclass.constructor.call(this);
};

Ext.extend(Tine.MailFiler.NodeTreePanel, Tine.widgets.container.TreePanel, {
    ...
    initComponent: function() {
        ...
        Tine.MailFiler.NodeTreePanel.superclass.initComponent.call(this);
     ...
     */
    // Tine.widgets.tree.FilterPlugin
    // Tine.MailFiler.PathFilterPlugin
    getFilterPlugin: function() {
        if (!this.filterPlugin) {
            this.filterPlugin = new Tine.MailFiler.PathFilterPlugin({
                treePanel: this,
                field: 'path',
    ...
    onBeforeCreateNode: function(attr) {
        Tine.MailFiler.NodeTreePanel.superclass.onBeforeCreateNode.apply(this, arguments);
        ...
        var nodeData = Ext.copyTo({}, attr, Tine.MailFiler.Model.Node.getFieldNames());
        attr.nodeRecord = new Tine.MailFiler.Model.Node(nodeData);
    },
    ...
    afterRender: function() {
        Tine.MailFiler.NodeTreePanel.superclass.afterRender.call(this);
    },
    ...
    onContextMenu: function(node, event) {
        ...
        Tine.log.debug('Tine.MailFiler.NodeTreePanel::onContextMenu - context node:');
        Tine.log.debug(node);
    ...
    onSelectionChange: function(sm, node) {
        ...
        Tine.MailFiler.NodeTreePanel.superclass.onSelectionChange.call(this, sm, node);
    ...
    onBeforeNodeDrop: function(dropEvent) {
        ...
        Tine.MailFiler.fileRecordBackend.copyNodes(nodes, target, !dropEvent.rawEvent.ctrlKey);
    ...
    cloneTreeNode: function(node, target) {
        ...
        if(node.attributes) {
            ...
            var nodeData = Ext.copyTo({}, node.data, Tine.MailFiler.Model.Node.getFieldNames());
            var newNodeRecord = new Tine.MailFiler.Model.Node(nodeData);
    ...
    onFolderRename: function(nodeData, node, newName) {
        ...
        Tine.MailFiler.NodeTreePanel.superclass.onSelectionChange.call(this, this.getSelectionModel(), node);
    },
    ...
    dropIntoTree: function(fileSelector, event) {
        ...
        Tine.MailFiler.fileRecordBackend.createNodes(params, uploadKeyArray, addToGridStore);
    }
});
