 ...
 * @class     Tine.MailFiler.PathFilterPlugin
 * @extends   Tine.widgets.grid.FilterPlugin
 */
Tine.MailFiler.PathFilterPlugin = Ext.extend(Tine.widgets.tree.FilterPlugin, {
        ...
        Ext.each(values, function(value) {
            ...
            this.selectPath.call(this.treePanel, treePath, null, function() {
                ...
                if (allValuesExpanded) {
                    ...
                    Tine.Tinebase.appMgr.get('MailFiler').getMainScreen().getCenterPanel().currentFolderNode = this.treePanel.getSelectionModel().getSelectedNode();
                }
