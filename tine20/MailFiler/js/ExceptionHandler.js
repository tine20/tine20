 ...
 */
Tine.MailFiler.handleRequestException = function(exception, request) {
    ...
    switch(exception.code) {
        ...
        case 503:
            Ext.MessageBox.show({
                ...
                msg: String.format(app.i18n._('The MailFiler is not configured correctly. Please refer to the {0}Tine 2.0 Admin FAQ{1} for configuration advice or contact your administrator.'),
                    '<a href="http://wiki.tine20.org/Admin_FAQ#The_message_.22filesdir_config_value_not_set.22_appears_in_the_logfile_and_I_can.27t_open_the_MailFiler" target="_blank">',
                    '</a>')
            });
            break;
        ...
        case 901:
            if (request) {
                Tine.log.debug('Tine.MailFiler.handleRequestException - request exception:');
                ...
                this.conflictConfirmWin = Tine.widgets.dialog.FileListDialog.openWindow({
                    ...
                    handler: function(button) {
                        ...
                        if (button == 'no') {
                            ...
                            Tine.log.debug('Tine.MailFiler.handleRequestException::' + params.method + ' -> only non-existant nodes.');
                            ...
                            Tine.log.debug('Tine.MailFiler.handleRequestException::' + params.method + ' -> replace all existing nodes.');
                        }

                        if (params.method == 'MailFiler.copyNodes' || params.method == 'MailFiler.moveNodes' ) {
                            Tine.MailFiler.fileRecordBackend.copyNodes(null, null, null, params);
                        } else if (params.method == 'MailFiler.createNodes' ) {
                            Tine.MailFiler.fileRecordBackend.createNodes(params, uploadKey, exception.addToGridStore);
                        }
                    }
                });
            ...
            break;
        case 902: // MailFiler_Exception_DestinationIsOwnChild
            Ext.MessageBox.show({
                buttons: Ext.Msg.OK,
                icon: Ext.MessageBox.ERROR,
            ...
            break;
        case 903: // MailFiler_Exception_DestinationIsSameNode
            Ext.MessageBox.show({
                buttons: Ext.Msg.OK,
