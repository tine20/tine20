 ...
 * @subpackage  Sieve
 */
class Expressomail_Sieve_Backend_Sql extends Expressomail_Sieve_Backend_Abstract
{
    /**
     * rules backend
     * 
    ...
    public function __construct($_accountId, $_readData = TRUE)
    {
        $this->_rulesBackend = new Tinebase_Backend_Sql(array(
            'modelName' => 'Expressomail_Model_Sieve_Rule', 
            'tableName' => 'expressomail_sieve_rule',
        ));

        $this->_vacationBackend = new Tinebase_Backend_Sql(array(
            'modelName' => 'Expressomail_Model_Sieve_Vacation', 
            'tableName' => 'expressomail_sieve_vacation',
        ));
    ...
    protected function _saveRules()
    {
        ...
        try {
            ...
            foreach ($this->_rules as $rule) {
                $ruleRecord = new Expressomail_Model_Sieve_Rule();
