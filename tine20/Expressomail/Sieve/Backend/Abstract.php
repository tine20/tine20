 ...
 * @subpackage  Sieve
 */
abstract class Expressomail_Sieve_Backend_Abstract
{
    /**
     * array of Sieve rules(Expressomail_Sieve_Rule)
     * 
     * @var array
     */
     ...
     * the vacation object
     * 
     * @var Expressomail_Sieve_Vacation
     */
     ...
     * @var string
     */
    protected $_generatorString = "#Generated by Expressomail_Sieve\r\n";
    
    /**
     * return array of Expressomail_Sieve_Rule
     * 
     * @return array
     */
     ...
     * add rule to script
     * 
     * @param Expressomail_Sieve_Rule $rule
     * @return Expressomail_Sieve_Vacation
     */
    public function addRule(Expressomail_Sieve_Rule $rule)
    {
     ...
     * set vacation
     * 
     * @param Expressomail_Sieve_Vacation $vacation
     */
    public function setVacation(Expressomail_Sieve_Vacation $vacation)
    {
     ...
     * 
     * @param Expressomail_Sieve_Backend_Abstract $_scriptToCopyFrom
     */
    public function getDataFromScript(Expressomail_Sieve_Backend_Abstract $_scriptToCopyFrom)
    {
