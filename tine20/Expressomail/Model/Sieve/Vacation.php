 ...
 * @package     Expressomail
 */
class Expressomail_Model_Sieve_Vacation extends Tinebase_Record_Abstract
{
    /**
    ...
    */
     ...
     * 
     * @param Expressomail_Sieve_Vacation $fsv
     */
    public function setFromFSV(Expressomail_Sieve_Vacation $fsv)
    {
