 ...
 * @package     Expressomail
 */
class Expressomail_Model_MessageFilter extends Tinebase_Model_Filter_FilterGroup
{
    /**
     ...
     */
    protected $_className = 'Expressomail_Model_MessageFilter';
    ...
    protected $_filterModel = array(
        'id'            => array('filter' => 'Tinebase_Model_Filter_Id', 'options' => array('modelName' => 'Expressomail_Model_Message')),
        'query'         => array(
        ...
        'received'      => array('filter' => 'Expressomail_Model_Filter_DateTime'),
        'messageuid'    => array('filter' => 'Tinebase_Model_Filter_Int'),
    // custom filters
        'path'          => array('custom' => true),
        'to'            => array('custom' => true, 'requiredCols' => array('to' => 'expressomail_cache_message_to.*')),
        'cc'            => array('custom' => true, 'requiredCols' => array('cc' => 'expressomail_cache_message_cc.*')),
        'bcc'           => array('custom' => true, 'requiredCols' => array('bcc' => 'expressomail_cache_message_bcc.*')),
        'flags'         => array('custom' => true, 'requiredCols' => array('flags' => 'expressomail_cache_msg_flag.flag')),
    ...
    protected function _addAccountFilter($_select, $_backend, array $_accountIds = array())
    {
        ...
        if (empty($accountIds)) {
            ...
            $what = array($correlationName => SQL_TABLE_PREFIX . 'expressomail_folder');
            $on = $db->quoteIdentifier("$correlationName.id")      . " = expressomail_cache_message.folder_id";
    ...
    protected function _getUserAccountIds()
    {
        if (empty($this->_userAccountIds)) {
            $this->_userAccountIds = Expressomail_Controller_Account::getInstance()->search(NULL, NULL, FALSE, TRUE);
        }
