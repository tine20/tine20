 ...
 * @class       Tine.Expressomail.sieve.VacationEditDialog
 ...
 */
 Tine.Expressomail.sieve.VacationEditDialog = Ext.extend(Tine.widgets.dialog.EditDialog, {
    ...
    recordProxy: Tine.Expressomail.vacationBackend,
    loadRecord: true,
    tbarItems: [],
    evalGrants: false,
    ...
    onRecordLoad: function() {
        ...
        Tine.log.debug('Tine.Expressomail.sieve.VacationEditDialog::onRecordLoad() -> record:');
    ...
    getTemplateItems: function(templates) {
        Tine.log.debug('Tine.Expressomail.sieve.VacationEditDialog::getTemplateItems()');
    ...
    onTemplateComboSelect: function(combo, record, index) {
        Tine.log.debug('Tine.Expressomail.sieve.VacationEditDialog::onTemplateComboSelect()');
    ...
    getVacationMessage: function() {
        this.loadMask.show();
        this.onRecordUpdate();
        Tine.Expressomail.getVacationMessage(this.record.data, this.onGetVacationMessage.createDelegate(this));
    },
    ...
    onGetVacationMessage: function(response) {
        Tine.log.debug('Tine.Expressomail.sieve.VacationEditDialog::onGetMessage()');
    ...
    onRecordUpdate: function() {
        Tine.Expressomail.sieve.VacationEditDialog.superclass.onRecordUpdate.call(this);
 ...
 */
Tine.Expressomail.sieve.VacationEditDialog.openWindow = function (config) {
    var window = Tine.WindowFactory.getWindow({
        width: 640,
        height: 550,
        name: Tine.Expressomail.sieve.VacationEditDialog.prototype.windowNamePrefix + Ext.id(),
        contentPanelConstructor: 'Tine.Expressomail.sieve.VacationEditDialog',
