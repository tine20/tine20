...
Ext.ns('Tine.Expressomail.sieve');

/**
 * @namespace Tine.Expressomail
 * @class     Tine.Expressomail.sieve.RulesGridPanel
 * @extends   Tine.widgets.grid.GridPanel
 * Rules Grid Panel <br>
 * 
 * @author      Philipp Schuele <p.schuele@metaways.de>
 */
Tine.Expressomail.sieve.RulesGridPanel = Ext.extend(Tine.widgets.grid.GridPanel, {
    /**
    ...
    editDialogClass: Tine.Expressomail.sieve.RuleEditDialog,
     ...
     * 
     * @param {Tine.Expressomail.Model.Rule} record
     * @param {Integer} index
     * @return {String}
     */
    getViewRowClass: function(record, index) {
        ...
        if (! record.get('enabled')) {
            className += ' expressomail-sieverule-disabled';
        }
    ...
    onStoreBeforeload: function(store, options) {
        Tine.Expressomail.sieve.RulesGridPanel.superclass.onStoreBeforeload.call(this, store, options);
    ...
    actionRenderer: function(type, metadata, record) {
        var types = Tine.Expressomail.sieve.RuleEditDialog.getActionTypes(this.app),
            result = type;
    ...
    conditionsRenderer: function(value) {
        ...
        if (value && value.length > 0) {
            ...
            var filterModels = Tine.Expressomail.sieve.RuleConditionsPanel.getFilterModel(app),
                header, 
                comperator, 
                found = false;
            ...
            if (found === true) {
                ...
                result = (condition.comperator == 'contains') ? app.i18n._('Header "{0}" contains "{1}"') : app.i18n._('Header "{0}" matches "{1}"');
    ...
    onUpdateRecord: function(encodedRecordData) {
        var newRecord = Tine.Expressomail.rulesBackend.recordReader({responseText: encodedRecordData});
