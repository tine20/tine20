 ...
 * @class       Tine.Expressomail.FolderSelectPanel
 * @extends     Ext.Panel
 * 
 ...
 * @param       {Object} config
 * @constructor
 * Create a new Tine.Expressomail.FolderSelectPanel
 */
Tine.Expressomail.FolderSelectPanel = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
        ...
        Tine.Expressomail.FolderSelectPanel.superclass.initComponent.call(this);
    },
    ...
    afterRender: function() {
        Tine.Expressomail.FolderSelectPanel.superclass.afterRender.call(this);
    ...
    onTreeNodeClick: function(node) {
        this.selectedNode = node;
        if(node.attributes.is_selectable)
            this.action_ok.setDisabled(false);
        else 
            this.action_ok.setDisabled(true);
    },
...
/**
 * Expressomail FolderSelectPanel Popup
 * 
 * @param   {Object} config
 * @return  {Ext.ux.Window}
 */
Tine.Expressomail.FolderSelectPanel.openWindow = function (config) {
    var window = Tine.WindowFactory.getWindow({
        width: 200,
        height: 300,
        modal: true,
        name: Tine.Expressomail.FolderSelectPanel.prototype.windowNamePrefix + Ext.id(),
        contentPanelConstructor: 'Tine.Expressomail.FolderSelectPanel',
