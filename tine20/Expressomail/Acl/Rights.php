...
/**
 * this class handles the rights for the Expressomail application
 * 
 * Expressomail has the following rights
 * - MANAGE_ACCOUNTS
 * 
 ...
 * @subpackage  Acl
 */
class Expressomail_Acl_Rights extends Tinebase_Acl_Rights_Abstract
{
    /**
     ...
     *
     * @return Expressomail_Acl_Rights
     */
    public static function getInstance() 
    {
        if (self::$_instance === NULL) {
            self::$_instance = new Expressomail_Acl_Rights;
        }
