 ...
 * @subpackage  Exception
 */
class Expressomail_Exception_IMAPInvalidCredentials extends Expressomail_Exception_IMAP
{
    /**
     * imap account
     * 
     ...
     * @return Expressomail_Exception_IMAPInvalidCredentials
     */
    public function setAccount(Expressomail_Model_Account $_account)
    {
