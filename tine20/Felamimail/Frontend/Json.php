...
class Felamimail_Frontend_Json extends Tinebase_Frontend_Json_Abstract
{
    ...
    public function testIMapSettings($accountId , $fields)
    {
        ...
        if (null == $params->user || null == $params->password) {
            $translation = Tinebase_Translation::getTranslation('Felamimail');
            throw new Tinebase_Exception_SystemGeneric($translation->_('Credentials missing'));
        }
    ...
    public function testSmtpSettings($accountId, $fields)
    {
        ...
        if (null == $fields['smtp_user'] && isset($fields['user'])) {
            $fields['smtp_user'] = $fields['user'];
        }
        if (null == $fields['smtp_password'] && isset($fields['password'])) {
        ...
        if (null == $account->smtp_hostname) {
            $translation = Tinebase_Translation::getTranslation('Felamimail');
            throw new Tinebase_Exception_SystemGeneric($translation->_('Hostname missing'));
        }

        if (null == $account->smtp_user || null == $account->smtp_password) {
            $translation = Tinebase_Translation::getTranslation('Felamimail');
            throw new Tinebase_Exception_SystemGeneric($translation->_('Credentials missing'));
        }
