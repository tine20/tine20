...
class Felamimail_Model_Message extends Tinebase_Record_Abstract implements Tinebase_BL_DataInterface
{
    ...
    protected $_validators = array(
        ...
        'to_list'               => array(Zend_Filter_Input::ALLOW_EMPTY => true),
        'cc_list'               => array(Zend_Filter_Input::ALLOW_EMPTY => true),
        'bcc_list'              => array(Zend_Filter_Input::ALLOW_EMPTY => true),
        ...
        'flag_list'             => array(Zend_Filter_Input::ALLOW_EMPTY => true),
