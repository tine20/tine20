...
{
    /**
     * the right to manage (update/delete) personal email accounts
     *
     * @staticvar string
     */
    ...
    /**
     * the right to add new personal email accounts
     *
     * @staticvar string
     */
    ...
    public static function getTranslatedRightDescriptions()
    {
        ...
        $rightDescriptions = array(
            self::MANAGE_ACCOUNTS => array(
                'text'          => $translate->_('Manage personal email accounts'),
                'description'   => $translate->_('Edit and delete personal email accounts'),
            ),
            self::ADD_ACCOUNTS => array(
                'text'          => $translate->_('Add personal email accounts'),
                'description'   => $translate->_('Create new personal email accounts'),
            ),
        );
