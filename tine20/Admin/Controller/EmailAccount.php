...
class Admin_Controller_EmailAccount extends Tinebase_Controller_Record_Abstract
{
     ...
     */
    public function convertEmailAccount(Felamimail_Model_Account $account, $to = Felamimail_Model_Account::TYPE_SHARED)
    {
        ...
        $userId = is_array($account->user_id) ? $account->user_id['accountId'] :  $account->user_id;
