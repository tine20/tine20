...
/**
 * SubProductMapping controller class for Sales application
 *
 * @package     Sales
 * @subpackage  Controller
 */
class Sales_Controller_SubProductMapping extends Tinebase_Controller_Record_Abstract
{
    ...
    protected function __construct()
    {
        ...
        $this->_backend = new Tinebase_Backend_Sql([
            Tinebase_Backend_Sql_Abstract::MODEL_NAME => Sales_Model_SubProductMapping::class,
            Tinebase_Backend_Sql_Abstract::TABLE_NAME => Sales_Model_SubProductMapping::TABLE_NAME,
            Tinebase_Backend_Sql_Abstract::MODLOG_ACTIVE => true,
        ]);
        $this->_modelName = Sales_Model_SubProductMapping::class;
