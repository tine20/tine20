...
class Voipmanager_Backend_Snom_Software extends Tinebase_Application_Backend_Sql_Abstract
{
    ...
    {
        parent::__construct(SQL_TABLE_PREFIX . 'snom_software', 'Voipmanager_Model_Snom_Software', $_db);
    }
     ...
     * @param  Voipmanager_Model_Snom_SoftwareFilter $_filter the filter values to search for
     */
    protected function _addFilter(Zend_Db_Select $_select, Voipmanager_Model_Snom_SoftwareFilter $_filter = NULL)
    {
