...
Tine.Voipmanager.Asterisk.SipPeers.Main = {
    ...
    displaySipPeersGrid: function() 
    {
        ...
        var columnModel = new Ext.grid.ColumnModel([
            ...
            { resizable: true, id: 'accountcode', header: this.translation._('account code'), dataIndex: 'accountcode', width: 30, hidden: true },
            { resizable: true, id: 'amaflags', header: this.translation._('ama flags'), dataIndex: 'amaflags', width: 30, hidden: true },
            { resizable: true, id: 'callgroup', header: this.translation._('call group'), dataIndex: 'callgroup', width: 30, hidden: true },
            { resizable: true, id: 'callerid', header: this.translation._('caller id'), dataIndex: 'callerid', width: 80 },
            { resizable: true, id: 'canreinvite', header: this.translation._('can reinvite'), dataIndex: 'canreinvite', width: 30, hidden: true },
            { resizable: true, id: 'context', header: this.translation._('context'), dataIndex: 'context', width: 50 },
            { resizable: true, id: 'defaultip', header: this.translation._('default ip'), dataIndex: 'defaultip', width: 30, hidden: true },
            { resizable: true, id: 'dtmfmode', header: this.translation._('dtmf mode'), dataIndex: 'dtmfmode', width: 30, hidden: true },
            { resizable: true, id: 'fromuser', header: this.translation._('from user'), dataIndex: 'fromuser', width: 30, hidden: true },
            { resizable: true, id: 'fromdomain', header: this.translation._('from domain'), dataIndex: 'fromdomain  	', width: 30, hidden: true },
            { resizable: true, id: 'fullcontact', header: this.translation._('full contact'), dataIndex: 'fullcontact', width: 200, hidden: true },
            { resizable: true, id: 'host', header: this.translation._('host'), dataIndex: 'host', width: 30, hidden: true },
            { resizable: true, id: 'insecure', header: this.translation._('insecure'), dataIndex: 'insecure', width: 30, hidden: true },
            { resizable: true, id: 'language', header: this.translation._('language'), dataIndex: 'language', width: 30, hidden: true },
            { resizable: true, id: 'mailbox', header: this.translation._('mailbox'), dataIndex: 'mailbox', width: 30},
            { resizable: true, id: 'md5secret', header: this.translation._('md5 secret'), dataIndex: 'md5secret', width: 30, hidden: true },
            { resizable: true, id: 'nat', header: this.translation._('nat'), dataIndex: 'nat', width: 30, hidden: true },
            { resizable: true, id: 'deny', header: this.translation._('deny'), dataIndex: 'deny', width: 30, hidden: true },
            { resizable: true, id: 'permit', header: this.translation._('permit'), dataIndex: 'permit', width: 30, hidden: true },
            { resizable: true, id: 'mask', header: this.translation._('mask'), dataIndex: 'mask', width: 30, hidden: true },
            ...
            { resizable: true, id: 'type', header: this.translation._('type'), dataIndex: 'type', width: 30 },
            { resizable: true, id: 'username', header: this.translation._('username'), dataIndex: 'username', width: 30, hidden: true },
            { resizable: true, id: 'disallow', header: this.translation._('disallow'), dataIndex: 'disallow', width: 30, hidden: true },
            { resizable: true, id: 'allow', header: this.translation._('allow'), dataIndex: 'allow', width: 30, hidden: true },
            { resizable: true, id: 'musiconhold', header: this.translation._('music on hold'), dataIndex: 'musiconhold', width: 30, hidden: true },
            { resizable: true, id: 'regseconds', header: this.translation._('reg seconds'), dataIndex: 'regseconds', width: 50, renderer: Tine.Voipmanager.Asterisk.SipPeers.Main.renderer.regseconds},
            { resizable: true, id: 'ipaddr', header: this.translation._('ip address'), dataIndex: 'ipaddr', width: 30, hidden: true },
            { resizable: true, id: 'regexten', header: this.translation._('reg exten'), dataIndex: 'regexten', width: 30, hidden: true },
            { resizable: true, id: 'cancallforward', header: this.translation._('can call forward'), dataIndex: 'cancallforward', width: 30, hidden: true },
            { resizable: true, id: 'setvar', header: this.translation._('set var'), dataIndex: 'setvar', width: 30, hidden: true },
            { resizable: true, id: 'notifyringing', header: this.translation._('notify ringing'), dataIndex: 'notifyringing', width: 30, hidden: true },
            { resizable: true, id: 'useclientcode', header: this.translation._('use client code'), dataIndex: 'useclientcode', width: 30, hidden: true },
            { resizable: true, id: 'authuser', header: this.translation._('auth user'), dataIndex: 'authuser', width: 30, hidden: true },
            { resizable: true, id: 'call-limit', header: this.translation._('call limit'), dataIndex: 'call-limit', width: 30, hidden: true },
            { resizable: true, id: 'busy-level', header: this.translation._('busy level'), dataIndex: 'busy-level', width: 30, hidden: true }
        ]);
