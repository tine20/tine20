...
class Voipmanager_Model_SnomSetting extends Tinebase_Record_Abstract
{
    ...
    protected $_validators = array(
        ...
        'redirect_always_on_code'   => array(Zend_Filter_Input::ALLOW_EMPTY => true), 
        'redirect_always_off_code'  => array(Zend_Filter_Input::ALLOW_EMPTY => true),  
        'redirect_busy_number'      => array(Zend_Filter_Input::ALLOW_EMPTY => true),
        'redirect_busy_on_code'     => array(Zend_Filter_Input::ALLOW_EMPTY => true),
        'redirect_busy_off_code'    => array(Zend_Filter_Input::ALLOW_EMPTY => true),
        'redirect_time'             => array(Zend_Filter_Input::ALLOW_EMPTY => true),
        'redirect_time_number'      => array(Zend_Filter_Input::ALLOW_EMPTY => true),
        'redirect_time_on_code'     => array(Zend_Filter_Input::ALLOW_EMPTY => true),
        'redirect_time_off_code'    => array(Zend_Filter_Input::ALLOW_EMPTY => true),
