 ...
 * @subpackage  Controller
 */
class Filemanager_Controller_Filesystem extends Tinebase_Controller_Abstract
{
    /**
    ...
    protected $_basePath = '/var/www/tine20devel/userdata/filemanager';
     ...
     *
     * @return Filemanager_Controller_Filesystem
     */
    public static function getInstance() 
    {
        if (self::$_instance === NULL) {
            self::$_instance = new Filemanager_Controller_Filesystem();
        }
        
        return self::$_instance;
    }
    
    public function intializeApplication($_applicationId)
    {
