...
Tine.Sipgate.AddressbookGridPanelHook = function(config) {
    ...
    Ext.ux.ItemRegistry.registerItem('Addressbook-Contact-GridPanel-ContextMenu', this.callContactAction, 130);
    ...
    Ext.ux.ItemRegistry.registerItem('Addressbook-Contact-GridPanel-ActionToolbar-leftbtngrp', this.composeSmsBtn, 30);
    Ext.ux.ItemRegistry.registerItem('Addressbook-Contact-GridPanel-ContextMenu', this.composeSmsAction, 140);
