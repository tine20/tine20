...
class HumanResources_Setup_Initialize extends Setup_Initialize
{
    ...
    protected function _initializeWageTypes()
    {
        $wageTypes = [
            ...
            ['id' => '10', 'number' => '5000', 'name' => 'Vacation',          'system' => true,  'wage_factor' => 100, 'additional_wage' => false], // _('Vacation')
    ...
    {
        $freeTimeTypes = [
            ['id' => '01', 'abbreviation' => '[S]', 'name' => '[S] Sickness',        'system' => true,  'wage_type' => '01', 'allow_booking' => false, 'allow_planning' => true,  'enable_timetracking' => false],
            ...
            ['id' => '03', 'abbreviation' => '[V]', 'name' => '[V] Vacation',        'system' => true,  'wage_type' => '10', 'allow_booking' => false, 'allow_planning' => true,  'enable_timetracking' => false],
