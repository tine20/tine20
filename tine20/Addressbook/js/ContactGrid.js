...
Tine.Addressbook.ContactGridPanel = Ext.extend(Tine.Tinebase.widgets.app.GridPanel, {
    ...
    getColumns: function(){
        return [
            ...
            { resizable: true, id: 'n_fileas', header: this.app.i18n._('Display Name'), dataIndex: 'n_fileas'},
            { resizable: true, id: 'org_name', header: this.app.i18n._('Company'), dataIndex: 'org_name', width: 200 },
            { resizable: true, id: 'org_unit', header: this.app.i18n._('Unit'), dataIndex: 'org_unit' , hidden: true },
            { resizable: true, id: 'title', header: this.app.i18n._('Job Title'), dataIndex: 'title', hidden: true },
            { resizable: true, id: 'role', header: this.app.i18n._('Job Role'), dataIndex: 'role', hidden: true },
            { resizable: true, id: 'room', header: this.app.i18n._('Room'), dataIndex: 'room', hidden: true },
            { resizable: true, id: 'adr_one_street', header: this.app.i18n._('Street'), dataIndex: 'adr_one_street', hidden: true },
            { resizable: true, id: 'adr_one_locality', header: this.app.i18n._('City'), dataIndex: 'adr_one_locality', width: 150, hidden: false },
            { resizable: true, id: 'adr_one_region', header: this.app.i18n._('Region'), dataIndex: 'adr_one_region', hidden: true },
            { resizable: true, id: 'adr_one_postalcode', header: this.app.i18n._('Postalcode'), dataIndex: 'adr_one_postalcode', hidden: true },
            { resizable: true, id: 'adr_one_countryname', header: this.app.i18n._('Country'), dataIndex: 'adr_one_countryname', hidden: true },
            { resizable: true, id: 'adr_two_street', header: this.app.i18n._('Street (private)'), dataIndex: 'adr_two_street', hidden: true },
            { resizable: true, id: 'adr_two_locality', header: this.app.i18n._('City (private)'), dataIndex: 'adr_two_locality', hidden: true },
            { resizable: true, id: 'adr_two_region', header: this.app.i18n._('Region (private)'), dataIndex: 'adr_two_region', hidden: true },
            { resizable: true, id: 'adr_two_postalcode', header: this.app.i18n._('Postalcode (private)'), dataIndex: 'adr_two_postalcode', hidden: true },
            { resizable: true, id: 'adr_two_countryname', header: this.app.i18n._('Country (private)'), dataIndex: 'adr_two_countryname', hidden: true },
            { resizable: true, id: 'email', header: this.app.i18n._('Email'), dataIndex: 'email', width: 150},
            { resizable: true, id: 'tel_work', header: this.app.i18n._('Phone'), dataIndex: 'tel_work', hidden: false },
            { resizable: true, id: 'tel_cell', header: this.app.i18n._('Mobile'), dataIndex: 'tel_cell', hidden: false },
            { resizable: true, id: 'tel_fax', header: this.app.i18n._('Fax'), dataIndex: 'tel_fax', hidden: true },
            { resizable: true, id: 'tel_car', header: this.app.i18n._('Car phone'), dataIndex: 'tel_car', hidden: true },
            { resizable: true, id: 'tel_pager', header: this.app.i18n._('Pager'), dataIndex: 'tel_pager', hidden: true },
            { resizable: true, id: 'tel_home', header: this.app.i18n._('Phone (private)'), dataIndex: 'tel_home', hidden: true },
            { resizable: true, id: 'tel_fax_home', header: this.app.i18n._('Fax (private)'), dataIndex: 'tel_fax_home', hidden: true },
            { resizable: true, id: 'tel_cell_private', header: this.app.i18n._('Mobile (private)'), dataIndex: 'tel_cell_private', hidden: true },
            { resizable: true, id: 'email_home', header: this.app.i18n._('Email (private)'), dataIndex: 'email_home', hidden: true },
            { resizable: true, id: 'url', header: this.app.i18n._('Web'), dataIndex: 'url', hidden: true },
            { resizable: true, id: 'url_home', header: this.app.i18n._('URL (private)'), dataIndex: 'url_home', hidden: true },
            { resizable: true, id: 'note', header: this.app.i18n._('Note'), dataIndex: 'note', hidden: true },
            { resizable: true, id: 'tz', header: this.app.i18n._('Timezone'), dataIndex: 'tz', hidden: true },
            { resizable: true, id: 'geo', header: this.app.i18n._('Geo'), dataIndex: 'geo', hidden: true },
            { resizable: true, id: 'bday', header: this.app.i18n._('Birthday'), dataIndex: 'bday', hidden: true }
        ];
    },
