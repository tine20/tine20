...
Tine.Addressbook.Model.Contact.getFilterModel = function() {
    ...
    var filters = [
        ...
        {label: app.i18n._('E-Mail (all)'),                                             field: 'email_query'},
        {label: app.i18n._('E-Mail'),                                                   field: 'email'},
        {label: app.i18n._('E-Mail (private)'),                                         field: 'email_home'},
...
//        {label: app.i18n._('Birthday'),    field: 'bday', valueType: 'date'},
        ...
        {label: app.i18n._('Country') + '  (' + app.i18n._('Company Address') + ')',    field: 'adr_one_countryname', filtertype: 'tinebase.country'},
        ...
        {label: app.i18n._('Country') + '  (' + app.i18n._('Private Address') + ')',    field: 'adr_two_countryname', filtertype: 'tinebase.country'},
        {label: app.i18n._('Type'), defaultValue: 'contact', valueType: 'combo',           field: 'type',               store: typeStore},
        {label: app.i18n._('Language'), field: 'language'},
