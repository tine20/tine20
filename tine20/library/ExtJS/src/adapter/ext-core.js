...
// NOTE: this adapter can't be build individually as begin/end files have invalid syntax!
(function(){
    var libFlyweight;
    ...
    // require('./ext-base-dom-more');
    Ext.lib.Dom.getRegion = function(el) {
        return Ext.lib.Region.getRegion(el);
    };

    // require('./core/ext-base-event');
...
//          },
    ...
    // require('./core/ext-base-anim-extra');
    // Easing functions
    (function(){
